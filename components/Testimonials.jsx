            ...
            <Wrapper>
                ...
                <Div className="mb-10 relative">
                    ...
                    <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                        Share your opinion on the skills and websites developed.
                    </div>
                </Div>
                {/* SECTION HEADING END */}
                    ...
                    <Carousel>
                        ...
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    src="https://img.freepik.com/premium-photo/handsome-male-client-signing-document-meeting-with-real-estate-agent_109710-1809.jpg"
                            ...
                            <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                                we are very much impressed by seeing the skills that you are having 
                                and you had an idea about all the websites that are there
                            </div>
                        </div>
                        {/* SLIDE END */}
                        {/* SLIDE START */}
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe1fued0xstjik4wclQdoduXYFFM7trlipraZJ4ZtTMdXOUoCOcq0qNlf_ivMBe5DDdME&usqp=CAU"
                                    className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                                />
                                <div className="font-bold">John Doy</div>
                                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
                        ...
                        <div className="text-black flex items-center flex-col px-[25px] md:px-[50px] py-[50px]">
                            <div className="mb-[25px]">
                                <img
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT7ZjM6jc0aJGxFIhi7CtG0e2_W_NGh44llPi9liP9pRyypUFVqc--AwRDzupa1ZtxO1o&usqp=CAU"
                                    className="w-[80px] h-[80px] max-w-[80px] rounded-full"
                                />
                                <div className="font-bold">John Doy</div>
                                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center">
