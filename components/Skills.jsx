                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="Frontend developer with experience of some of the projects  that maintain a better code for reusability i'm passionate about learning and development with a desire to apply skills on larger projects"
                            data={[
                                "Responsive",
                                "Single page",
                                "User Experience",
                        ...
                        <Service
                            num="2"
                            title="Python DSA"
                            desc="Data Structures and Algorithms are some of the most important topics for prrogrammers to learn in order to acquire a job and do well.Good code is build on a solidunderstanding in data structures."
                            data={[
                                "stacks",
                                "queue",
                                "Linked List",
                        ...
                        <Service
                            ...
                            desc="Backend development with the django with the experience of some of the projects that maintain a code resuability on other projects."
                            data={[
                                "Prototype",
                                "Reusability",
                                "User Experience",
